...
TEST(V2, ReserveAndCapacityBasics) {
    Obj::ResetCounters();
...
TEST(V2, ExceptionSafetyAndRollbacks) {
...
TEST(V2, PushBackPopBackAndResize) {
    const size_t ID = 42;
    const size_t SIZE = 100500;
    {
        Obj::ResetCounters();
...
TEST(V2, IteratorsInsertEmplaceAndErase) {
