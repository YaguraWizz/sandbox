...
namespace sandbox {
    ...
    public:
        ...
        explicit SimpleVector(std::size_t size) : items_(size), size_(size), capacity_(size) {}

        SimpleVector(ReserveProxyObj reserved) : items_(reserved.capacity), size_(0), capacity_(reserved.capacity) {}
